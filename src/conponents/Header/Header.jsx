...
const Header = () => {
    ...
    return (
        ...
        <Navbar.Toggle/>
        <Navbar.Collapse>
        <Nav className="me-auto my-2 my-lg-0 " style={{textAlign:"center"}}>
                <Nav.Link className='my-under px-0 mx-2' as={NavLink} to="/home"><FontAwesomeIcon icon="fa-solid fa-list"/> Activity</Nav.Link>
        ...
        <Nav>
                ...
                <Nav.Link className='my-under' href="#action3" ><FontAwesomeIcon icon="fa-regular fa-note-sticky" /> Notes</Nav.Link>
                <Nav.Link className='my-under' href="#action4"><FontAwesomeIcon icon="fa-regular fa-user" /> Friends</Nav.Link>
                <Nav.Link className='my-under' href="#action5"><FontAwesomeIcon icon="fa-regular fa-user" /> Photos</Nav.Link>
